const EnglishNames = {
  ...
  EntryBar: {
    ...
    regErrorIncorrectLogin: "Login must consist of English letters. You can add digits",
...
const RussianNames = {
  ...
  EntryBar: {
    ...
    regErrorIncorrectLogin: "Логин должен состоять из английских букв. Можно добавлять цифры",
